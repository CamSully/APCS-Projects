...
import java.text.*;
/**
 * IndustryHolder simulates a stockholder of the industrial sector.
 * 
 * @author Cameron Sullivan
 * @version 2016.1.31
 */
public class IndustryHolder extends StockHolder implements FundControl
{
    ...
    public IndustryHolder(String name, String birthdate, double balance) {
        // Complete the superclass constructor with identical parameters.
        super(name, birthdate, balance);
        // Set a random stock price from $30-$54.
        sharePrice = random.nextInt(2500) + 3000;
        sharePrice /= 100;
    }
    ...
    public void sellStock (int sharesToSell) {
        // Find a random change in the price of the stock ($0.5-$5.99).
        double shareChange = random.nextInt(600) + 50;
        shareChange /= 100;
