...
import java.text.*;
/**
 * FinancialHolder simulates a stockholder of the finance sector.
 * 
 * @author Cameron Sullivan
 * @version 2016.1.31
 */
public class FinancialHolder extends StockHolder implements FundControl
{
    ...
    public FinancialHolder(String name, String birthdate, double balance) {
        // Complete the superclass constructor with identical parameters.
        super(name, birthdate, balance);
        // Set a random stock price from $20-$65.
        sharePrice = random.nextInt(4500) + 2000;
        sharePrice /= 100;
    }
    ...
    public void sellStock (int sharesToSell) {
        // Find a random change in the price of the stock ($10-$29).
        double shareChange = random.nextInt(2000) + 1000;
        shareChange /= 100;
