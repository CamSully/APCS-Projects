...
import java.text.*;
/**
 * EnergyHolder simulates a stockholder of the energy sector.
 * 
 * @author Cameron Sullivan
 * @version 2016.1.31
 */
public class EnergyHolder extends StockHolder implements FundControl
{
    ...
    public EnergyHolder(String name, String birthdate, double balance) {
        // Complete the superclass constructor with identical parameters.
        super(name, birthdate, balance);
        // Set a random stock price from $15-$30.
        sharePrice = random.nextInt(1600) + 1500;
        sharePrice /= 100;
    }
    ...
    public void sellStock (int sharesToSell) {
        // Find a random change in the price of the stock ($0.5-$3.49).
        double shareChange = random.nextInt(400) + 50;
        shareChange /= 100;
        ...
        if (sharesToSell > 0 && sharesToSell <= shareNum) {
            ...
            investment = shareNum * sharePrice;
